    ...
    <div class="container">
        <header class="header">
            ...
            <div class="buttons">
                ...
                <a href="homewikiP.php" class="home-button"><i class="fas fa-home"></i></a>
    ...
    <div class="table-container">
        ...
        <?php foreach ($komik as $k) : ?>
            <table>
                ...
                <tr>
                    <td colspan=""><a href="HpembacaK.php?id=<?= $k['id']; ?>">deskripsi.</td>
    ...
    <div class="table-container">
        ...
        <?php foreach ($anime as $a) : ?>
            <table>
                ...
                <tr>
                    <td colspan=""><a href="HpembacaA.php?id=<?= $a['id']; ?>">deskripsi.</td>
